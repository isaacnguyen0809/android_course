...
data class CollectionItemResponse(
  ...
  @Json(name = "last_collected_at") val lastCollectedAt: String, // 2023-08-02T14:34:33Z
  @Json(name = "updated_at") val updatedAt: String, // 2023-08-02T14:34:33Z
  @Json(name = "featured") val featured: Boolean, // true
  @Json(name = "total_photos") val totalPhotos: Int, // 42
  ...
  @Json(name = "cover_photo") val coverPhoto: CoverPhotoResponse,
  @Json(name = "preview_photos") val previewPhotos: List<PreviewPhotoResponse>
)
...
data class TagResponse(
  ...
  data class Source(
    ...
    data class CoverPhoto(
      ...
      @Json(name = "updated_at") val updatedAt: String, // 2023-09-25T10:07:07Z
      ...
      @Json(name = "likes") val likes: Int, // 241
      ...
      data class TopicSubmissions(
        ...
        data class Blue(
          @Json(name = "status") val status: String, // approved
          @Json(name = "approved_on") val approvedOn: String? = null // 2023-07-31T17:31:58Z
        )
      }
      ...
      data class User(
        ...
        @Json(name = "updated_at") val updatedAt: String, // 2023-09-25T17:11:59Z
        ...
        @Json(name = "bio") val bio: String?, // Photographer based in Rome //Follow on Instagram for more @serenarepice //                                        If you use my photos, please tag me //                                       Support me and my work with a donation! Thank you
        ...
        @Json(name = "total_photos") val totalPhotos: Int, // 267
...
data class UserResponse(
  ...
  @Json(name = "updated_at") val updatedAt: String, // 2023-10-06T13:41:53Z
  ...
  @Json(name = "location") val location: String?, // Iowa, United States
  @Json(name = "links") val links: Links,
  @Json(name = "profile_image") val profileImage: ProfileImage,
  @Json(name = "instagram_username") val instagramUsername: String?, // InkyPixels
  @Json(name = "total_collections") val totalCollections: Int, // 100
  @Json(name = "total_likes") val totalLikes: Int, // 56
  ...
  @Keep
  data class ProfileImage(
    @Json(name = "small") val small: String, // https://images.unsplash.com/profile-1691076421761-45731e726e5fimage?ixlib=rb-4.0.3&crop=faces&fit=crop&w=32&h=32
    @Json(name = "medium") val medium: String, // https://images.unsplash.com/profile-1691076421761-45731e726e5fimage?ixlib=rb-4.0.3&crop=faces&fit=crop&w=64&h=64
    @Json(name = "large") val large: String // https://images.unsplash.com/profile-1691076421761-45731e726e5fimage?ixlib=rb-4.0.3&crop=faces&fit=crop&w=128&h=128
  )
...
data class CoverPhotoResponse(
  ...
  @Json(name = "updated_at") val updatedAt: String, // 2023-09-21T23:52:58Z
  ...
  @Json(name = "urls") val urls: Urls,
  @Json(name = "links") val links: Links,
  @Json(name = "likes") val likes: Int, // 3
  @Json(name = "liked_by_user") val likedByUser: Boolean, // false
  @Json(name = "current_user_collections") val currentUserCollections: List<Any>,
  @Json(name = "sponsorship") val sponsorship: Any?, // null
  @Json(name = "topic_submissions") val topicSubmissions: TopicSubmissions?,
  ...
  data class TopicSubmissions(
    ...
    data class ArchitectureInterior(
      @Json(name = "status") val status: String, // approved
      @Json(name = "approved_on") val approvedOn: String? = null // 2023-07-07T12:42:10Z
    )
    ...
    data class Wallpapers(
      @Json(name = "status") val status: String, // rejected
      @Json(name = "approved_on") val approvedOn: String? = null, // 2020-06-22T14:01:37Z
    )

    @Keep
    data class Nature(
      @Json(name = "status") val status: String, // approved
      @Json(name = "approved_on") val approvedOn: String? = null // 2020-06-22T11:24:02Z
    )
  ...
  data class User(
    ...
    @Json(name = "updated_at") val updatedAt: String, // 2023-10-08T22:26:00Z
    ...
    @Json(name = "total_collections") val totalCollections: Int, // 34
    @Json(name = "total_likes") val totalLikes: Int, // 14
    @Json(name = "total_photos") val totalPhotos: Int, // 3261
    @Json(name = "accepted_tos") val acceptedTos: Boolean, // true
    @Json(name = "for_hire") val forHire: Boolean, // true
    @Json(name = "social") val social: Social
  ) {
    ...
    @Keep
    data class ProfileImage(
      @Json(name = "small") val small: String, // https://images.unsplash.com/profile-1696365126880-238bc4433ef6?ixlib=rb-4.0.3&crop=faces&fit=crop&w=32&h=32
      @Json(name = "medium") val medium: String, // https://images.unsplash.com/profile-1696365126880-238bc4433ef6?ixlib=rb-4.0.3&crop=faces&fit=crop&w=64&h=64
      @Json(name = "large") val large: String // https://images.unsplash.com/profile-1696365126880-238bc4433ef6?ixlib=rb-4.0.3&crop=faces&fit=crop&w=128&h=128
    )
